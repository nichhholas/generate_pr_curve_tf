...
def ValidatePaths(arg, nameArg, errors):
    print('At ValidatePaths')
    print(arg)
    print(os.path.abspath(arg), os.path.isdir(os.path.abspath(arg)))
    if arg is None:
        errors.append('argument %s: invalid directory' % nameArg)
    elif (os.path.isdir(arg) or os.path.isdir(os.path.abspath(arg))) is False and (os.path.isdir(os.path.join(currentPath, arg)) or os.path.isdir(os.path.join(currentPath, os.path.abspath(arg))) ) is False:
    ...
    #     arg = os.path.join(currentPath, arg)
        ...
        # print('Filepath not found', os.path.isdir(os.path.abspath(arg)))
        # arg = os.path.join(currentPath, arg)
...
if ValidateMandatoryArgs(args.gtFolder, '-gt/--gtfolder', errors):
    ...
    gtFolder = os.path.abspath(gtFolder)
...
if ValidateMandatoryArgs(args.detFolder, '-det/--detfolder', errors):
    ...
    detFolder = os.path.abspath(detFolder)
...
if args.savePath is not None:
    ...
    saveOath = os.path.abspath(savePath)
# Validate savePath
