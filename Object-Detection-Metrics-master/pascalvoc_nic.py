...
def ValidatePaths(arg, nameArg, errors):
    ...
    elif (os.path.isdir(arg) or os.path.isdir(os.path.abspath(arg))) is False and (os.path.isdir(os.path.join(currentPath, arg)) or os.path.isdir(os.path.abspath(os.path.join(currentPath, arg))) ) is False:
...
print("Get groundtruth boxes")
allBoundingBoxes, allClasses = getBoundingBoxes(
    gtFolder, True, gtFormat, gtCoordType, imgSize=imgSize)
# Get detected boxes
print("Get detected boxes")
allBoundingBoxes, allClasses = getBoundingBoxes(
...
acc_AP = 0
validClasses = 0
print("Finished getting groundtruth and detected boxes")
